...
// Skalerer et elements INDHOLD (ikon/tekst/billede) op eller ned via CSS transform, UDEN at
// aendre selve boksens x/y/w/h -- det er stadig boksen (og dermed "fast plads"-geometrien,
// naboelementer osv.) der bestemmer hvor meget plads der er, boksens EGEN overflow:hidden
// klipper indholdet hvis det skaleres ud over kanten. Sat paa den enkelte indholds-node (ikke
// paa selve .el) saa det ALDRIG rammer redigerings-headeren ovenpaa, og saa boksens egen
// clip-graense ikke ogsaa vokser med (hvilket ville ske hvis transform sad paa selve .el).
